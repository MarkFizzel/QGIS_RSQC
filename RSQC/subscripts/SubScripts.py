...
def readtxt3():
    file1 = open(os.path.dirname(__file__) + "\\" + "DBinfo2.txt", "r")
    overwritedata = file1.readline()
    overwritedata = overwritedata.rstrip()
    select = file1.readline()
    select = select.rstrip()
    path = file1.readline()
    path = path.rstrip()
    drevnavn = file1.readline()
    drevnavn = drevnavn.rstrip()
    DB_table = file1.readline()
    DB_table = DB_table.rstrip()
    file1.close()
    os.remove(os.path.dirname(__file__) + "\\" + "DBinfo2.txt")
    return(overwritedata, select, path, drevnavn, DB_table)

def readtxt4():
    file1 = open(os.path.dirname(__file__) + "\\" + "kill.txt", "r")
    killed = file1.readline()
    killed = killed.rstrip()
    file1.close()
    os.remove(os.path.dirname(__file__) + "\\" + "kill.txt")
    return(killed)